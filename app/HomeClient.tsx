...
export default function HomeClient({ featuredBooks, categoryCounts }: Props) {
  ...
  return (
    <>
      ...
      {/* Shipping banner */}
      <div className="bg-moss text-cream text-center py-2.5 px-4 font-jost text-xs tracking-wide">
        📦 {t('shippingBanner')}
      </div>
      ...
      <section className="py-16 px-6 bg-cream" id="categories">
        <div className="text-center mb-10">
          <p className="font-jost text-[13px] uppercase tracking-widest text-ink-muted mb-2">Collection</p>
